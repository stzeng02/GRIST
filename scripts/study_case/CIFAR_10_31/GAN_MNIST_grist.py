...
def generator(z, reuse=False):
    with tf.variable_scope('generator', reuse=reuse):
        ...
        # output hidden layer
        G_w3 = tf.get_variable('G_w3', [1024, 1024], initializer=w_init)
        G_b3 = tf.get_variable('G_b3', [1024], initializer=b_init)
...
def discriminator(image, drop_out, reuse=False):
    with tf.variable_scope('discriminator', reuse=reuse):
        ...
        # 1st hidden layer
        D_w0 = tf.get_variable('D_w0', [1024, 1024], initializer=w_init)
